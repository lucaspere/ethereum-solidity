...
contract AMMRouter is IAMMRouter {
    ...
    constructor(address _factory) {
        factory = _factory;
        // IPairFactory(factory) faz um "cast" do endereço factory para o tipo IPairFactory
        // Isso permite chamar funções definidas na interface IPairFactory no contrato que está naquele endereço
        // O msg.sender será o endereço do contrato AMMRouter, não o factory
        // O factory é apenas o endereço do contrato que estamos chamando
